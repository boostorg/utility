...
typedef boost::basic_cstring_view<char, constexpr_char_traits> cstring_view;

int main()
{
    constexpr cstring_view sv1;
    constexpr cstring_view sv2{"abc"}; // ptr, len
    constexpr cstring_view sv3{"def"}; 	 // ptr
